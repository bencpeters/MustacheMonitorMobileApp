...
#define CDV_PHOTO_PREFIX    @"mustache_monitor_"
...
- (void) takePicture:(CDVInvokedUrlCommand*)command
{
    ...
    //make stash overlay
    UIImage *stashOverlay = [UIImage imageNamed:@"stash-overlay.png"];
    
    CGSize size = CGSizeMake(221,320);
    
    UIGraphicsBeginImageContext(size);
    [stashOverlay drawInRect:CGRectMake(0,0,size.width,size.height)];
    UIImage* overlay = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    
    UIImageView *cameraOverlayView = [[UIImageView alloc] initWithImage:overlay];
    
    cameraOverlayView.center = cameraPicker.view.center;
    ...
    cameraPicker.cameraOverlayView = cameraOverlayView;
